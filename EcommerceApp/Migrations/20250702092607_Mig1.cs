        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Shirts and Jeans", "Clothes" },
                    { 4, "Vegetables and fastfoods", "Foods" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "DiscountPercent", "ImageUrl", "IsAvailable", "Name", "Price", "StockQuantity" },
                values: new object[,]
                {
                    ...
                    { 4, 4, "This is about horror scene about a group of Students visiting an abandoned hospital.", 10, "https://example.com/images/horror-novel.jpg", true, "Horror Novel", 35.53m, 20 },
                    { 5, 3, "This is a white T-shirt and is suitable for one who love peace.", 10, "https://example.com/images/white-Tshirt.jpg", true, "T-shirt", 150.53m, 35 }
                });
